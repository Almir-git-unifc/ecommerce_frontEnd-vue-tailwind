            ...
            <div class="mb-20 flex flex-col gap-12 lg:flex-row">
                ...
                <div class="lg:w-1/2">
                    <div class="relative h-96 overflow-hidden rounded-2xl shadow-xl">
                        ...
                        <!-- imagem original         -->
                        <img  src="product0" alt="Leading product"                              
                ...
                <div class="lg:w-1/2 flex flex-col justify-center">
                    ...
                    <p class="text-lg text-gray-600 mb-4">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Est dicta 
                          recusandae ratione  voluptatibus sapiente, sint a velit saepe ipsum 
                         laborum quas hic earum iusto! Praesentium  mollitia nam soluta inventore 
                         sapiente.
                    </p>
