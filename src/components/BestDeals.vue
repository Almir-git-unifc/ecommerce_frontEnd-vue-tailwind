<template>
  <section id="home" class="bg-amber-50 scroll-mt-20 py-16">
    ...
    >
      <!-- Left Content -->
      <div class="text-center lg:text-left max-w-xl lg:w-1/2">
        ...
        <div class="flex justify-center lg:justify-start gap-4">
          ...
          <a
            href="/offers"   class="px-6 py-3 border border-pink-500 text-pink-600 text-sm font-semibold rounded-lg hover:bg-pink-200 transition"
          >
            View Offers
          </a>
        </div>
